...
class ExecutorManager {
    ...
    static final int DEVICE_INFO_UNKNOWN = 0;
    static ExecutorService eventExecutor;
    //private static final int CPU_COUNT = Runtime.getRuntime().availableProcessors();
    static final int CPU_COUNT = ExecutorManager.getCountOfCPU();
    static final int CORE_POOL_SIZE = CPU_COUNT + 1;
    static final int MAXIMUM_POOL_SIZE = CPU_COUNT * 2 + 1;
    static final int KEEP_ALIVE = 1;
    static final BlockingQueue<Runnable> eventPoolWaitQueue = new LinkedBlockingQueue<>(128);
    static final ThreadFactory eventThreadFactory = new ThreadFactory() {
    ...
    static final RejectedExecutionHandler eventHandler =
